...
var _ storagev1alpha1listers.VolumeAttachmentLister = &VolumeAttachmentClusterLister{}

// VolumeAttachmentClusterLister implements the storagev1alpha1listers.VolumeAttachmentLister interface.
...
func NewVolumeAttachmentClusterLister(indexer cache.Indexer) storagev1alpha1listers.VolumeAttachmentLister {
	return &VolumeAttachmentClusterLister{indexer: indexer}
}

// List lists all storagev1alpha1.VolumeAttachment in the indexer.
...
// Get retrieves the storagev1alpha1.VolumeAttachment from the indexer for a given name.
func (s VolumeAttachmentClusterLister) Get(name string) (*storagev1alpha1.VolumeAttachment, error) {
	panic("Calling 'Get' is not supported before scoping lister to a workspace")
}

// Cluster returns an object that can list and get storagev1alpha1.VolumeAttachment.
