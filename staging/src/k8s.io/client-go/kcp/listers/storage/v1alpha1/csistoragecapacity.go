...
var _ storagev1alpha1listers.CSIStorageCapacityLister = &CSIStorageCapacityClusterLister{}

// CSIStorageCapacityClusterLister implements the storagev1alpha1listers.CSIStorageCapacityLister interface.
...
func NewCSIStorageCapacityClusterLister(indexer cache.Indexer) storagev1alpha1listers.CSIStorageCapacityLister {
	return &CSIStorageCapacityClusterLister{indexer: indexer}
}

// List lists all storagev1alpha1.CSIStorageCapacity in the indexer.
...
// CSIStorageCapacities returns an object that can list and get storagev1alpha1.CSIStorageCapacity.
func (s CSIStorageCapacityClusterLister) CSIStorageCapacities(namespace string) storagev1alpha1listers.CSIStorageCapacityNamespaceLister {
	panic("Calling 'CSIStorageCapacities' is not supported before scoping lister to a workspace")
}

// Cluster returns an object that can list and get storagev1alpha1.CSIStorageCapacity.
...
// List lists all storagev1alpha1.CSIStorageCapacity in the indexer for a given namespace.
...
// Get retrieves the storagev1alpha1.CSIStorageCapacity from the indexer for a given namespace and name.
